    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: true,
                logo: {
                    darkLogo: '.../static/src/assets/img/logo-bmkg.png',
                    lightLogo: '../static/src/assets/img/logo-bmkg.png'
                }
            }
        },
        reset: false
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '../static/src/assets/img/logo-bmkg.png')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
